...
namespace QuanLyMyPham
{
    public partial class HoaDon_nhanvien : Form
    {
        ...
        private void txt_sanpham_TextChanged_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void txt_timkiemsp_TextChanged_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_themchititethoadon_Click_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btn_xoachitiethoadon_Click_1(object sender, EventArgs e)
        {
            try
            {
               ...
               if(cbx_hinhthucthanhtoan.Text == "")
                ...
                else
                {
                    ...
                    if (kt)
                    {
                        ...
                        in_hoadon IN_hoadon = new in_hoadon(ID_hoadon, tongtien, date);
                        IN_hoadon.Show();
                    }
                    else
                    {
        ...
        private void date_ngayxuat_ValueChanged(object sender, EventArgs e)
        {

        }

        private void dgv_chitiethoadon_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
